...
*/
    export function Container({children}) {
        ...
        */
            return (
                <div className="container-fluid" style={{overflow:'hidden',padding:'0px'}}>
                    {children}
                </div>
            );
    }
...
*/
    export function Row({children,s=null}) {
        ...
        //style
        let defaultStyleOBJ = {overflow:'hidden',height:'auto', marginBottom:'2vh'} ;
        let payloadForUpdateStyleObjectOBJ = {'s':s,'defaultStyleOBJ':defaultStyleOBJ} ;
        defaultStyleOBJ = styleServiceOBJ.updateStyleObject(payloadForUpdateStyleObjectOBJ) ;
        ...
        */
            return (
                <div className={classNameGroupSTR} style={defaultStyleOBJ} dir={ cookieStateSTR === 'en'?'ltr':'rtl'} >
                    {children}
                </div>
            );
    }
...
*/
    export function Bg({children,p=null,s=null}) {
        ...
        let payloadForUpdateBootStrapClassOBJ = {'p':p,'defaultClassSTR':defaultClassSTR} ;
        defaultClassSTR = styleServiceOBJ.updateBootStrapClass(payloadForUpdateBootStrapClassOBJ) ;

        //style
        let defaultStyleOBJ ={backgroundColor:'',padding:'0vh 0%',borderRadius:'0px 0px',color : 'black',overflow:'hidden',boxShadow:'0px 0px 0px 0px rgba(0 0 0 / 30%)'};
        let payloadForUpdateStyleObjectOBJ = {'s':s,'defaultStyleOBJ':defaultStyleOBJ} ;
        defaultStyleOBJ = styleServiceOBJ.updateStyleObject(payloadForUpdateStyleObjectOBJ) ;
